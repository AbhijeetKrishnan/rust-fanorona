...
"""
Script generated by Claude Sonnet-3.7 to visualize the Fanorona board state given its
bitboard representation as an integer.

Prompt used:
> Write a Python program to visualize the first 45 bits of an integer arranged as a 5 x 9 grid with the bottom row
containing bits 0 to 8, then 9 to 17, and so on until the top row which contains bits 36 to 44

> Remove the dependency on matplotlib and simply print the grid with 1s and 0s
"""
